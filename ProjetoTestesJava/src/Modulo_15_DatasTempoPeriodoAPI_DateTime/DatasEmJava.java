...
public class DatasEmJava {
	...
	public static void main(String[] args) throws ParseException, InterruptedException {
		...
		System.out.println("Data antiga é anterior a atual >>> " + dataAntiga.isBefore(dataNova));
		System.out.println("Data antiga e atual são iguais >>> " + dataAntiga.isEqual(dataNova));
		
		// Trabalhando com Periodos em java - diferença entre datas
